...
%ML ran with learning_rate=0.00055 iterations=4000
if(percentCalc == 0.4)
...
elseif(percentCalc < 0.56 && percentCalc > 0.54)
    ...
    %alpha=0.875 beta=0.75 startSecretary=0.55 startCritical=0.8 intervals=10
    %Loss=80.90672 Test=80.851906 Error=75.85214482779682
%     A = [0.9405306  -0.06855205  1.1829499   1.1421431  -0.04500046 -0.257234    0.47940603 -0.6626221   0.44542715  2.3245895   0.9438433  -2.0268726 ];
%     b = 15.762493;
%     norm = [4.867549669	3.774834437	3.40397351	3.370860927	3.013245033	3.033112583	3.079470199	3.072847682	3.350993377	4.072847682	381.9205298	6.214218439;
%             3.696260266	3.516005661	2.99372412	2.82280214	2.65577799	2.800993201	2.915528949	2.877729053	2.982613341	3.716807479	51.50903133	4.222203975];
